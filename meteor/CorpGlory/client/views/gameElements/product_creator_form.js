Template.product_creator_form.onRendered(function(){

	var form = $("#product_creator_form");
...
Template.product_creator_form.helpers({
    spheres:function(){
        return Spheres.find({});
    },
...
Template.product_creator_form.events({
